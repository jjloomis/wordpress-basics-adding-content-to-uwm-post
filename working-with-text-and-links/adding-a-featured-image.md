...
A **Featured Image** is the image that appears in a home page card (**Top Stories**, **Headlines**, etc.) or special project grid card. When using the **Featured Image Position options**, the **Featured Image** is also the hero image (large image on top of the story.)
