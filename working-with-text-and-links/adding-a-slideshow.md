...
#### Creating a slideshow <a href="#creating-a-slideshow" id="creating-a-slideshow"></a>
...
6. To change the width of the slideshow within the post, click the slideshow to select it. Then use the alignment options to change the width of the slideshow. (Generally, the **Wide width** option is a good choice for slideshows.)

#### Editing a slideshow <a href="#editing-a-slideshow" id="editing-a-slideshow"></a>
